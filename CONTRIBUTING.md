...
Contributions are always welcome! Please use the following guidelines when contributing to `mgrs`

1. Fork `mgrs`
2. Clone your fork (`git clone https://github.com/$YOUR_USERNAME/mgrs-rs && cd mgrs-rs`)
